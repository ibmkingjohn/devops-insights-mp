...
$databases = array (
  ...
  array (
    ...
    array (
      'database' => 'mp',
      'username' => 'admin',
      'password' => 'RZLZLYVXELIVNUHP',
      'host' => 'sl-us-south-1-portal.0.dblayer.com',
      'port' => '20050',
      'driver' => 'mysql',
    ),
  ),
...
/* $databases = array();*/
  ...
  $conf['redis_client_host']      = 'sl-us-south-1-portal.4.dblayer.com';  // Your Redis instance hostname.
  $conf['redis_client_port']      = 20150;
  $conf['redis_client_password']  = 'YJXWBREMNLKCUNYS';
  $conf['lock_inc']               = 'sites/all/modules/adminmodules/redis/redis.lock.inc';
  $conf['path_inc']               = 'sites/all/modules/adminmodules/redis/redis.path.inc';
  $conf['cache_backends'][]       = 'sites/all/modules/adminmodules/redis/redis.autoload.inc';
